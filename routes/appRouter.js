...
import { deleteFile, deleteFolder, generateShareLink, getFileMetadata, startDownload } from "../controllers/fileController.js";
...
appRouter.delete('/files/:fileId', isAuth, deleteFile);
appRouter.delete('/folders/:folderId', isAuth, deleteFolder);
